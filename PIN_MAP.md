...
| J           | B             | Syringe Height  | DM556T #5  | 21        | 22        | 31        | 320      | 295         | 5 mm/rev lead screw. `AXIS5_NAME='B'`. `INVERT_J_DIR true`. |
| K           | C             | Syringe         | DM556T #6  | 13        | 19        | 20        | 1600     | 125         | 1 mm/rev lead screw (→ 1600 steps/mm). `AXIS6_NAME='C'`, `EXTRUDERS 0`. Homeable linear axis (was E0 extruder). `INVERT_K_DIR true`, homes to MIN. Stroke ~135 mm, travel limit capped at 125 mm. Pins unchanged (13/19/20). |
