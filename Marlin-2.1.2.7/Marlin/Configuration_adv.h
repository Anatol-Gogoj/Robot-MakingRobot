...
//                               X  Y  Z   I  J
#define HOMING_BUMP_MM      { 5, 5, 10, 2, 2, 2 }   // (linear=mm) Backoff after first bump (X,Y,Z,I,J,K)
#define HOMING_BUMP_DIVISOR { 2, 2, 4,  4, 4, 4 }   // Re-Bump Speed Divisor (X,Y,Z,I,J,K)
...
#define HOME_Z_FIRST                        // Home Z first — Z must clear before XY move to prevent tool crash
...
//#define DISABLE_IDLE_Z    // Disabled — lead-screw Z is not backdrivable; re-enable glitch caused phantom Z steps on XY moves
 ...
 */
#define EMERGENCY_PARSER   // RMR: real-time M112 (E-STOP) + M410 (sequencer Stop) even during blocking moves/M750 (issue #40)
