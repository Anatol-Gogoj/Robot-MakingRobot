...
Travel limits (mm):      X=770  Y=200  Z=186  I=343  J=300  K=125   (Y max 200 only at X>=350, else 150)
...
- [x] ~~Set actual travel limits~~ (X=770, Y=200, Z=186, I=343, J=300, K=125 — matching `Configuration.h:1741,1743,1745`)
